...
public static class ContextBuilder
{
    ...
    {
        var bot = Activator.CreateInstance<TBot>();
    ...
    {
        var botUser = Activator.CreateInstance<TBotUser>();
    ...
    public static object CreateTelegramBotUser<TKey>(Type botUserType, TKey userId, TKey botId)
        where TKey : IEquatable<TKey>
    {
        var botUser = Activator.CreateInstance(botUserType);
    ...
    {
        var userRole = Activator.CreateInstance<TBotUserRole>();
    ...
    public static object CreateTelegramBotUserRole<TKey>(Type botUserRoleType, TKey botUserId, TKey roleId)
        where TKey : IEquatable<TKey>
    {
        var botUserRole = Activator.CreateInstance(botUserRoleType);
