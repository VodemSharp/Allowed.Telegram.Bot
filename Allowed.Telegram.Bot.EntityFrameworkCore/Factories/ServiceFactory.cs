...
public class ServiceFactory : IServiceFactory
{
    ...
    {
        return (IUserService<TKey, TUser>)ActivatorUtilities.CreateInstance(_provider, typeof(UserService<TKey, TUser>),
            botId);
    }
    ...
    {
        return (IRoleService<TKey, TRole>)ActivatorUtilities.CreateInstance(_provider, typeof(RoleService<TKey, TRole>),
            botId);
    }
}